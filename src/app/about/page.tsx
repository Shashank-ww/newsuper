    ...
    return (
      ...
      <div className="w-full h-[90vh] relative" style={{ 
        ...
        <div className="pb-4 flex flex-col z-1 text-center max-w-4xl mx-auto">
          ...
          <h1 className="tracking-tight font-bold py-4 lg:text-6xl md:text-5xl text-4xl bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-sky-400 hover:from-amber-500 hover:to-red-500 transition-colors duration-700">The Supersqad <span className="font-normal">story</span>
          </h1>
          <p className="my-4 text-md text-primary">
            <i>It all starts with manifesting ideas</i>
          </p>
          </div>
        </div>
      </div>
            ...
            <div className="md:max-w-screen-md items-center justify-center mx-auto text-gray-800">
              <ul> 
                ...
                <li className="py-2">With a vision where capitalism isn&apos;t about making profits – but empowering people to make informed decisions.<span className="font-bold"> At Supersqad, we&apos;re using the power of media and technology to do just that.</span> 
                  </li>

...
<MaxWidthWrapper>
  <div className="flex flex-col md:flex-row px-8 items-center justify-evenly gap-6">

    {/* Verified Resources */}
    <div className="group p-4 cursor-default transition-transform duration-300 rounded-sm hover:shadow-md hover:scale-110 hover:bg-gray-900">
      <div className="flex items-center justify-center">
        <svg
          ...
          className="
            ...
            drop-shadow-[0_0_6px_rgba(245,158,11,0.6)]
            group-hover:drop-shadow-[0_0_10px_rgba(245,158,11,0.9)]
          "
        >
          <path
            strokeLinecap="round"
    ...
    {/* Global Inclusivity */}
    <div className="group p-4 cursor-default transition-transform duration-300 rounded-sm shadow-md hover:scale-110 hover:bg-gray-900">
      <div className="flex items-center justify-center">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
